        ...
        <div className="container mx-auto max-w-4xl">
          <div className="animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mb-8">
              We're building a service agent for NRIs anywhere. Whether you need
              help with visa appointments, banking, or navigating Indian red
              tape, our platform serves to be your best friend, combining neat
              tech with real human help so you can get things done in India. No
