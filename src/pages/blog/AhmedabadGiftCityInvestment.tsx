      ...
      <main className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <article className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-10">Why Ahmedabad Works as the Base</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-10">Who's Moving In</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-10">Is There an Investment Play?</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-10">The Five-Year View</h2>
