      ...
      <main className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <article className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-10">What's the Big Deal About the OCI?</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-10">Why Do We Put Off the OCI Application?</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-10">Why Sooner Is Smarter</h2>
