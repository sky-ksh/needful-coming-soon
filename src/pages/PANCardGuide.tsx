        ...
        <div className="mt-16 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-foreground">
              This is just one item on your India paperwork to-do list. If you'd like help with OCI, Passport Surrender, banking, or getting anything done in India, join the Needful Community. It's free - you'll get resources, reminders, and help when you need it.
            </p>
