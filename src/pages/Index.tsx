        ...
        <div className="container mx-auto px-6">
          <div className="mb-12 animate-fade-in">
            <div className="max-w-4xl">
              <p className="text-xl md:text-2xl text-foreground leading-relaxed text-left">Founded by a team of Indian immigrant students and professors at MIT, Needful is an AI platform that simplifies Indian paperwork and wealth management for NRIs (Non-Resident Indians) and NRI-facing businesses.</p>
            </div>
          </div>
