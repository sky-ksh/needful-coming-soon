      ...
      <div className="relative overflow-hidden min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <div className="mb-8 animate-fade-in flex items-center justify-center gap-4">
            <div className="w-20 h-20 md:w-24 md:h-24 bg-primary flex items-center justify-center rounded-2xl px-0">
              <span className="text-black font-bold text-6xl md:text-7xl">N</span>
            </div>
          ...
          animationDelay: "0.2s"
            ...
            <p className="text-2xl lg:text-4xl leading-relaxed font-sans text-muted-foreground">Personal Assistant for Global Indians</p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="mb-12 animate-fade-in">
            <div className="max-w-4xl">
              <p className="text-xl md:text-2xl text-foreground leading-relaxed text-left">Founded by a team of Indian immigrant students and professors at MIT, Needful is an AI-powered platform that helps Non-Resident Indians (NRIs) manage cross-border life and wealth.</p>
            </div>
          </div>
